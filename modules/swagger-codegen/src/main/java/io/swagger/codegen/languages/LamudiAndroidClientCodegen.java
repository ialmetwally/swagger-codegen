...
public class LamudiAndroidClientCodegen extends DefaultCodegen implements CodegenConfig {
    private static final Logger LOGGER = LoggerFactory.getLogger(LamudiAndroidClientCodegen.class);
    public static final String FULL_JAVA_UTIL = "fullJavaUtil";
    public static final String DEFAULT_LIBRARY = "<default>";

    public static final String API_POSTFIX = "Service";
    private static final String MODEL_POSTFIX = "DTO";
    private static final String PARAM_PREFIX = "m";
    private static final String RESPONSE_PARENT = "BaseResponse";
    private static final String DTO_PARENT = "BaseDTO";
    ...
    public LamudiAndroidClientCodegen() {
        super();
...
//        supportedLibraries.put("retrofit", "HTTP client: OkHttp 2.4.0. JSON processing: Gson 2.3.1 (Retrofit 1.9.0)");
    ...
    public String getName() {
        return "lamudiAndroid";
    }

    @Override
    public String getHelp() {
        return "Generates a Lamudi Android client library.";
    }
...
//        }
    ...
    public String toVarName(String name) {
        return PARAM_PREFIX + initialCaps(getVarName(name));
    }
    ...
    public String getterAndSetterCapitalize(String name) {
        ...
        return camelize(getVarName(name));
    ...
    public String toModelName(String name) {
        ...
        name = camelize(name);
        return isDTO(name) ? name + MODEL_POSTFIX : name;
    }
    ...
    private boolean isDTO(String name) {
        return !( typeMapping.keySet().contains(name)
                || importMapping.keySet().contains(name)
    ...
    public CodegenModel fromModel(String name, Model model, Map<String, Model> allDefinitions) {
        ...
        if (isResponse(codegenModel.classname)) {
            codegenModel.parent = RESPONSE_PARENT;
        } else {
            codegenModel.parent = DTO_PARENT;
        }
        return codegenModel;
    }
    ...
    public String toApiName(String name) {
        return initialCaps(name) + API_POSTFIX;
    }
